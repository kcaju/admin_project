...
import 'package:admin_project/ui/screens/dogs_tab/dog_viewmodel.dart';
...
class DogView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var dogBreeds = FirebaseFirestore.instance.collection("Dogbreeds");
