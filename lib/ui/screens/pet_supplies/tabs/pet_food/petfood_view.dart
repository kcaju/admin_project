...
import 'package:admin_project/ui/screens/pet_supplies/tabs/pet_food/petfood_viewmodel.dart';
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          onTap: () async {
                            await petFoods.doc(documents[index].id).delete();
                          },
                          child: CircleAvatar(
