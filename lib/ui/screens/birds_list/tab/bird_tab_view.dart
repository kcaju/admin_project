...
import 'package:admin_project/ui/screens/birds_list/tab/birdtab_viewmodel.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:flutter/material.dart';
import 'package:shimmer/shimmer.dart';
import 'package:stacked/stacked.dart';

class BirdTabView extends StatelessWidget {
  const BirdTabView(
      {super.key,
      required this.name,
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<BirdtabViewmodel>.reactive(
      viewModelBuilder: () {
        return BirdtabViewmodel();
      },
